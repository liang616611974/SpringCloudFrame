...
public class InputStreamHelper {
    ...
    /**
     * 将InputStream转换成Base64String
     *
     * @param in 输入流
     * @return
     */
    public static String inputStreamToBase64String(InputStream in) {
        return Base64.encodeBase64String(inputStreamToByte(in));
    }

    /**
     * 将Base64String转换成InputStream
     *
     * @param data
     * @return
     */
    public static InputStream base64StringToInputStream(String data) {
        return byteToInputStream(Base64.decodeBase64(data));
    }
