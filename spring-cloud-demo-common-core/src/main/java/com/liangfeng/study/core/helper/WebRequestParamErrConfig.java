...
import com.liangfeng.study.core.config.AppCommonConfig;
...
public class WebRequestParamErrConfig extends ResponseEntityExceptionHandler {
	...
	protected ResponseEntity<Object> handleBindException(BindException ex, HttpHeaders headers, HttpStatus status, WebRequest request) {
		printVistLog((ServletWebRequest) request);
	 ...
	 */
	private void printVistLog(ServletWebRequest servletWebRequest) {
		HttpServletRequest httpRequest = servletWebRequest.getRequest();
		logger.info("【 requestUrl:{} , httpMethod:{} , IP:{}】",
				httpRequest.getRequestURL().toString(),
				httpRequest.getMethod(),
				WebHelper.getRequestIp(httpRequest));
	}
